...
if (isset($_POST['update_status'])) {
    ...
    $query = "SELECT name, email, blood_type FROM need_blood WHERE id = '$request_id'";
    ...
    if ($row = mysqli_fetch_assoc($result)) {
        ...
        if (mysqli_query($conn, $update_query)) {
            ...
            if ($new_status == "Fulfilled") {
                ...
                if ($emailStatus === true) {
                    echo "<script>alert('Status updated successfully! Email sent.'); window.location.href='email.php';</script>";
                } else {
